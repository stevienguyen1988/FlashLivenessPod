...
+ (LivenessUtilityDetector * _Nonnull)createLivenessDetectorWithPreviewView:(UIView * _Nonnull)previewView mode:(enum FlashLivenessMode)mode debugging:(BOOL)debugging delegate:(id <LivenessUtilityDetectorDelegate> _Nullable)delegate additionParam:(NSDictionary<NSString *, id> * _Nonnull)additionParam additionHeader:(NSDictionary<NSString *, NSString *> * _Nonnull)additionHeader SWIFT_WARN_UNUSED_RESULT;

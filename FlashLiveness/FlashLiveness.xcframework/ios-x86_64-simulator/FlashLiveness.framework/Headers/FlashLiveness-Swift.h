...
#ifndef FLASHLIVENESS_SWIFT_H
#define FLASHLIVENESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlashLiveness",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13FlashLiveness24AdvancedLivenessMaskView")
@interface AdvancedLivenessMaskView : UIView
...
typedef SWIFT_ENUM(NSInteger, LivenessError, open) {
  ...
  LivenessErrorBigFace = 2,
  LivenessErrorFacePose = 3,
  LivenessErrorBadImage = 4,
  LivenessErrorNoVerificationInstruction = 5,
  LivenessErrorBadResponse = 6,
  LivenessErrorTwoFace = 7,
  LivenessErrorHangError = 8,
};
...
SWIFT_CLASS("_TtC13FlashLiveness14LivenessResult")
...
/// \param liveness đối tượng <em>LivenessUtilityDetector</em>
///
/// \param images đối tượng LivenessFaceImages, trong đó chứa 1 mảng images khi liveness, tương ứng index với từng màu filterColors được truyền vào
///
...
SWIFT_CLASS("_TtC13FlashLiveness10Networking") SWIFT_AVAILABILITY(ios,introduced=13.0)
